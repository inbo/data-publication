...
/****** Object:  View [ipt].[vwGBIF_INBO_LSVI 3130_occurrences]    Script Date: 25/01/2019 14:36:12 ******/
SET ANSI_NULLS ON
GO
...
2019-01-20  aanpassen voor LSVI 3130
2019-01-25  klein hackje voor LSVI3130 (UNION ALL MET DE ONTBREKENDE....

*********************************/

 CREATE View [ipt].[vwGBIF_INBO_LSVI 3130_occurrences]
AS
...
--	and ST.SHORT_NAME <> 'Weather' 
    AND qualifierShortName in ('None')
--	AND DataShortName in ('Tansley')
--	AND qualifierDescription IS NOT NULL
	AND TAO.[TAXON_OCCURRENCE_KEY] NOT IN ('BFN0017900007LB6','BFN0017900007LB4','BFN0017900007LB2','BFN0017900007LB3','BFN0017900007LB5')


UNION ALL

SELECT *
FROM [ipt].[vwGBIF_INBO_LSVI 3130_occurrences2]
