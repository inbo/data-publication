...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_vuursalamander transecten_events]    Script Date: 23/08/2019 14:03:28 ******/
SET ANSI_NULLS ON
GO
...
SELECT * FROM [iptdev].[vwGBIF_INBO_meetnetten_vuursalamander transecten_events];

*/

/* generieke query events, test met vuursalamander
   We creëren meerdere datasets uit meetnetten op basis van protocol
   Aanmaken query vuursalamander op basis van protocol

 */

CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_vuursalamander transecten_events]
AS
