...
```{r}
input_event <- read_excel(here::here("datasets", "vmm-macroinvertebrates-events", "data", "interim", "2022events.xlsx"))

input_occurrence <- read_excel(here::here("datasets", "vmm-macroinvertebrates-events", "data", "interim", "2022occurrence.xlsx"))

input_meas <- read_excel(here::here("datasets", "vmm-macroinvertebrates-events", "data", "interim", "2022MeasurementOrFact.xlsx"))
```
