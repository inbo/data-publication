...
```{r}
write_csv(occurrence, here::here("datasets", "vmm-macroinvertebrates-events", "data", "processed", "occurrence.csv"), na = "")

write_csv(event, here::here("datasets", "vmm-macroinvertebrates-events", "data", "processed", "event.csv"), na = "")

write_csv(measurements, here::here("datasets", "vmm-macroinvertebrates-events", "data", "processed", "measurements.csv"), na = "")
```
