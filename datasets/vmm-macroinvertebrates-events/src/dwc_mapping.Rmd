...
write_csv(event, here::here("datasets", "mica-vmm-occurrences", "data", "processed", "event.csv"), na = "")

write_csv(measurements, here::here("datasets", "mica-vmm-occurrences", "data", "processed", "measurements.csv"), na = "")
```
