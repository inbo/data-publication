...
/****** Object:  View [ipt].[vwGBIF_INBO_Grensmaas_vegetatieopnamen_occurrences]    Script Date: 12/12/2018 9:41:56 ******/
SET ANSI_NULLS ON
GO
...
ALTER View [ipt].[vwGBIF_INBO_Grensmaas_vegetatieopnamen_occurrences]
AS
