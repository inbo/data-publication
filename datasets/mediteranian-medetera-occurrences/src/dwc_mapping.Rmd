...
```
```{r}
input_data_habitat <- read_delim(here::here("datasets", "mediteranian-medetara-occurrences", "data", "raw", "occID_habitat2.csv"), ";")
```
...
```{r}
occurrence %<>% mutate(dwc_eventID = str_replace_all(sample_cd, '/', ':'))
```
