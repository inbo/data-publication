...
/****** Object:  View [ipt].[vwGBif_VISverdichtingsMeetnetOccurrence]    Script Date: 15/05/2024 10:39:48 ******/
SET ANSI_NULLS ON
GO
...
/**ALTER VIEW [ipt].[vwGBif_VISverdichtingsMeetnetOccurrence]
	AS**/
...
SELECT
 ...
 --   , [rights] = N'http://creativecommons.org/publicdomain/zero/1.0/'
    ...
    , [datasetID] = N'http://dataset.inbo.be/vis-freshwater-additional-monitoring-occurrences'
    , [institutionCode] = N'INBO'
    , [collectionCode] = N'VIS'
