...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën - fuiken (v1)_occurrence]    Script Date: 23/08/2019 13:57:58 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën - fuiken (v1)_occurrence]
AS
