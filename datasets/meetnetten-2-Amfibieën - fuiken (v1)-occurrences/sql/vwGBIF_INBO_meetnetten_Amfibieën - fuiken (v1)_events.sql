...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën - fuiken (v1)_events]    Script Date: 23/08/2019 13:57:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_Amfibieën - fuiken (v1)_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - Amfibieën - fuiken (v1), Belgium'
