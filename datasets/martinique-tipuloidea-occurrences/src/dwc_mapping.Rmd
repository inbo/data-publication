...
```
```{r}
input_data <- read_delim(here::here("datasets", "martinique-tipuloidea-occurrences", "data", "interim", "occurrence4.csv"), ",")
```
...
```{r}
occurrence %<>% mutate(dwc_datasetName = "Tipuloidea from Martinique")
```
...
```{r}
occurrence %<>% mutate(dwc_taxonRank = case_when(dwc_scientificName == 'Geranomyia sp.1'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Geranomyia sp.2'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Geranomyia sp.3'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Geranomyia sp.4'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Geranomyia sp.5'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Toxorhina (Toxorhina) sp.1'   ~ "morfospecies"
                                                 ,dwc_scientificName == 'Toxorhina (Toxorhina) sp.2'   ~ "morfospecies"
                                                 ,TRUE ~ "species"
                                                 ))
