...
```{r}
occurrence %<>% mutate(dwc_eventDate_begin = as.Date(date_b))
```
```{r}
occurrence %<>% mutate(dwc_eventDate_end = as.Date(date_e))
```

```{r}
occurrence %<>% mutate(dwc_eventDate = paste(occurrence$date_b, "/" , occurrence$date_e))
```
...
occurrence %<>% mutate(dwc_samplingProtocol = recode(method_cd
                                                     ...
                                                     ,"BPT" = "blue pan traps"
                                                     ,"PT" = "pan traps"
                                                     ,"MSW" = "municipal solid waste sampling"
                                                     )) 
```
### sex
