...
/****** Object:  View [ipt].[INBOSchorrenLangendonckEventCore]    Script Date: 13/03/2024 9:36:46 ******/
SET ANSI_NULLS ON
GO
...
/**ALTER VIEW [ipt].[INBOVegSchorrenLangendonckEventCore]
AS**/
...
/**record level**/
	...
	, [associatedReferences] = 'Bulletin de la Société Royale de Botanique de Belgique, t. LXV, fasc2, 1933'
	--, '<!!!>' as Split1
	---, lr.*
	---, ActionGroup 
	---, ListName 
...
/**	, r.ElementCode
	...
	, [habitat] = 'Le Salicornietum herbaceae'
--	, '<!!!>' as Split3
/**	, r.VagueDateBegin
	, r.VagueDateEnd
	, r.VagueDateType  **/
