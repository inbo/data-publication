...
```{r}
occurrence %<>% mutate(datasetID = "to complete")
```
...
```{r}
occurrence %<>% mutate(rightsHolder = "Provincie Oost Vlaanderen") # e.g. "INBO"
```
### accessRights
...
```{r}
occurrence %<>% mutate(institutionCode = "Provincie Oost Vlaanderen") # e.g. "INBO"
```

### datasetName

```{r}
occurrence %<>% mutate(datasetName = "Eikenprocessierups in East Flanders, Belgium") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
