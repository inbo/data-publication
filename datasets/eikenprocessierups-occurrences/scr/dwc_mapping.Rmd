...
input_interim <- read_delim(here::here("datasets", "eikenprocessierups-occurrences", "data", "interim", "2022_12_12EPRgegevensRAWRefine.csv" ),',')
...
```{r}
input_interim <- union(input_interim, input_interimDec)
```
