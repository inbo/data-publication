...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_butterfly transects(algemene monitoring)_occurrence]    Script Date: 23/08/2019 13:58:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_butterfly transects(algemene monitoring)_occurrence]
AS
...
WHERE 1=1
---AND ProjectName = 'Butterfly transects (algemene monitoring)'
