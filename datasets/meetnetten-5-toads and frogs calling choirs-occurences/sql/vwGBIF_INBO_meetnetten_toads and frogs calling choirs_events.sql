...
/****** Object:  View [iptdev].[vwGBIF_INBO_meetnetten_toads and frogs calling choirs_events]    Script Date: 23/08/2019 14:48:57 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [iptdev].[vwGBIF_INBO_meetnetten_toads and frogs calling choirs_events]
AS
...
SELECT --fa.*   --unieke kolomnamen
	...
	, [datasetName] = N'Meetnetten - toads and frogs calling choirs, Belgium'
