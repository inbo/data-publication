...
Query metadata for all datasets on [INBO IPT](https://www.gbif.org/installation/9f25fd85-85dc-4dcd-a1b4-b31165442e2b):
...
datasets <- 
  ...
  map_df(function(x) list(
    ...
    last_publication = date(x$pubDate),
    update_freq = ifelse(
...
```{r}
write_csv(datasets, here("data", "datasets.csv"), na = "")
```
